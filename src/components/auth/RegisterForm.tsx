    ...
    return (
      <Card className="w-full max-w-md mx-auto">
        <CardHeader className="text-center">
          <CardTitle className="text-xl">Konto skapat!</CardTitle>
          <CardDescription>
        ...
        <CardContent className="space-y-4">
          <div className="p-4 rounded-lg bg-muted space-y-2">
            <div>
              <p className="text-sm font-medium">Välkommen till DISSG</p>
              <p className="text-xs text-muted-foreground">
                Du har nu tillgång till alla Observer-funktioner. Utforska dashboard och indikatorer.
              </p>
            </div>
          </div>
        </CardContent>
